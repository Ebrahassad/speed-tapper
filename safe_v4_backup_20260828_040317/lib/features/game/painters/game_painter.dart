...
import '../widgets/power_up_painter.dart';
...
class GamePainter extends CustomPainter {
  ...
  void _paintBallTrail(Canvas canvas) {
    ...
    for (int i = 0; i < ballTrail.points.length; i++) {
      final point = ballTrail.points[i];

      final double t = (i + 1) / ballTrail.points.length;

      final double radius = ballRadius * (0.20 + (t * 0.55));
